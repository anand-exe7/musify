        ...
        <form onSubmit={submit} className="mt-8 space-y-5">
          ...
          <label className="block">
            <div className="flex items-center justify-between">
              ...
              <Link href="#" className="mb-1.5 text-[10px] uppercase tracking-widest text-gold-600 hover:underline">
                Forgot?
              </Link>
            </div>
            <div className="relative">
              <input
                ...
                defaultValue="••••••••"
                required
                className="w-full border border-ink-200 bg-ivory-50 px-4 py-3 pr-11 text-sm text-ink-900 focus:border-gold-500 focus:outline-none"
              />
              <button
                type="button"
